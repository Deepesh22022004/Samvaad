...
import AiChatBotLink from '@/components/AiChatBotLink'
...
const layout: FC<LayoutProps> = async ({ children }: LayoutProps) => {
    ...
    if (!session) notFound() // middleware to protect route 
            ...
            <div className='flex h-full w-full max-w-xs grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6'>
                <Link href='/dashboard' className='flex h-16 shrink-0 items-center'>
                    ...
                    <Image
                        src='/logo.png'
                        alt='Logo'
                        width={20} // Adjust the width for the small logo
                        height={20} // Adjust the height for the small logo
                ...
                <nav className='flex flex-1 flex-col'>
                    <ul role='list' className='flex flex-1 flex-col gap-y-7'>
                        ...
                        <li>
                            ...
                            <ul role='list' className='-mx-2 mt-2 space-y-1'>
                                <AiChatBotLink userId={session.user.id} />
                            </ul>
                        </li>
