...
export const FriendRequestSidebarOption: FC<FriendRequestSidebarOptionProps> = ({
    sessionId,
    ...
    useEffect(() => {
        ...
        pusherClient.bind('friend_request_denied', denyFriendHandler)  // Handle deny event
        ...
        return () => {
            ...
            pusherClient.unbind('friend_request_denied', denyFriendHandler)
